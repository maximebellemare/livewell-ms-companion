      ...
      {showNav && location.pathname === "/profile" && (
        <OnboardingTooltips
          ...
          steps={[
            ...
            { target: "profile-notifications", title: "Notifications & email digest", description: "Control push notification permissions, manage per-channel community alerts, and toggle the weekly email digest that summarises your symptom trends every Monday.", position: "bottom" },
          ]}
        />
      )}
