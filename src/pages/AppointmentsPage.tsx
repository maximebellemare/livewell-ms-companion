          ...
          {isLoading ? (
            ...
            <div className="rounded-2xl bg-card border border-border shadow-soft px-6 py-10 text-center space-y-3 animate-fade-in">
              ...
              <h3 className="font-display text-base font-semibold text-foreground">
                {viewMode === "calendar" ? "Nothing scheduled today" : "No appointments yet"}
              </h3>
              <p className="text-sm text-muted-foreground max-w-xs mx-auto leading-relaxed">
                {viewMode === "calendar"
                  ? "This day is open. Schedule a visit whenever you're ready."
                  : "Keep track of your appointments so nothing slips through the cracks."}
              </p>
