    ...
    <>
      ...
      <div className="mx-auto max-w-lg px-4 py-4 space-y-4 animate-fade-in">
        ...
        <div className="rounded-xl bg-card p-4 shadow-soft">
          ...
          <button
            onClick={() => {
              ["onboarding_tour_v1", "onboarding_tour_track_v1", "onboarding_tour_insights_v1", "onboarding_tour_community_v1", "onboarding_tour_journal_v2", "onboarding_tour_learn_v1", "onboarding_tour_relapses_v2", "onboarding_tour_medications_v1", "onboarding_tour_appointments_v1"].forEach((k) => localStorage.removeItem(k));
